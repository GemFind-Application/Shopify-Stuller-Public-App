...
var diamondcookiedata = getCookie('comparediamondProduct');
if(diamondcookiedata){
jQuery.ajax({
            url: baseurl + 'diamondtools/loadcompare',
            data: {comparediamondProduct:diamondcookiedata,shop:shopurl,pathprefixshop:pathprefixshop},
            type: 'POST',
