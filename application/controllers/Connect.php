...
class Connect extends CI_Controller {
	...
	{		
		...
		if($_SERVER['HTTP_SEC_FETCH_DEST'] == 'iframe'){
			  ...
			  if(isset($_REQUEST['SubmitStullerSetting']))
			  {
					...
					if($data['stullerconfigdata']){	
						...
						$this->general_model->updateData($adminOptionData,$shop);
						 ...
						 $data["stullerconfigdata"]->showcase_url = $this->input->post('showcase_url');
						 $data["stullerconfigdata"]->enable_app = $this->input->post('enable_app');
		   ...
		   // $redirectURL = 'https://'.$shop.'/admin/apps/gemfind-stuller';
	    	...
	    	$redirectURL = 'https://admin.shopify.com/store/'.$shopDomain.'/apps/gemfind-stuller';
	...
	public function registerShopifyAppUninstallWebhookStuller($shop_domain,$access_token){
		...
		$admin_toEmail = ['dev@gemfind.com', 'support@gemfind.com', 'billing@gemfind.com','sales@gemfind.com','appinstall@gemfind.com'];
